				...
				<nav class="discovery--nav">
					<ul class="discovery--nav--list tab-filter--list u-no-scrollbar">
						<li class="discovery--nav--list--item tab-filter--item is-active">
							<a class="tab-filter" href="ArtistDetails.aspx?Id=<%=Id %>">Overview</a>
						</li>
						<li class="discovery--nav--list--item tab-filter--item">
							<a class="tab-filter" href="ArtistSongs.aspx?Id=<%=Id %>">Songs</a>
						</li>
						<li class="discovery--nav--list--item tab-filter--item">
							<a class="tab-filter" href="ArtistAlbums.aspx?Id=<%=Id %>">Albums</a>
						</li>
							...
							<main class="discovery--section">
								...
								<section class="standard--holder">
									<div class="discovery--section--header">
										<h2>Top Songs</h2>
										<a class="discovery--section--header--view-all" href="ArtistSongs?Id=<%=Id %>">View All</a>
								</div><!-- /.discovery-select -->

									<ul id="playlist" class="song-list mod-new mod-menu">

										<asp:Repeater runat="server" id="topSongs">
											<ItemTemplate>
												<li class="song-list--item media-player--row">

													<div class="song-list--item--player-img media-player">
														<img class="song-list--item--player-img--img" 
														src="<%#Eval("imageURL") %>" alt="<%#Eval("AlbumTitle") %>">
													</div>
													...
													<div class="song-list--item--right">
														...
														<div class="song-list--item--icon--holder">
															<a href="#" class="song-list--item--icon--wrap" style="<%# Convert.ToBoolean(Eval("multitracks")) ? "diplay: inline-block" : "display: none" %>">
															...
															<a href="#" class="song-list--item--icon--wrap" style="<%# Convert.ToBoolean(Eval("customMix")) ? "diplay: inline-block" : "display: none" %>">
															...
															<a href="#" class="song-list--item--icon--wrap" style="<%# Convert.ToBoolean(Eval("rehearsalMix")) ? "diplay: inline-block" : "display: none" %>">
															...
															<a href="#" class="song-list--item--icon--wrap" style="<%# Convert.ToBoolean(Eval("patches")) || Convert.ToBoolean(Eval("songSpecificPatches"))? "diplay: inline-block" : "display: none" %>">
															...
															<a href="#" class="song-list--item--icon--wrap" style="<%# Convert.ToBoolean(Eval("chart")) ? "diplay: inline-block" : "display: none" %>">
															...
															<a href="#" class="song-list--item--icon--wrap" style="<%# Convert.ToBoolean(Eval("proPresenter")) ? "diplay: inline-block" : "display: none" %>">
								...
								<div class="discovery--space-saver">
									<section class="standard--holder">
										<div class="discovery--section--header">
											<h2>Albums</h2>
											<a class="discovery--section--header--view-all"href="ArtistAlbums?Id=<%=Id %>">View All</a>
										</div><!-- /.discovery-select -->
								...
								<section id="bio" class="standard--holder">
									<div class="discovery--section--header">
										<h2>Biography</h2>
									</div><!-- /.discovery-section-header -->

									<div class="artist-details--biography biography">
										<p runat="server" id="artistBio1"></p>
										<span id="dots"></span>
										<p runat="server" id="artistBio2"></p>
										
										<a href="#bio" role="button" onclick="ReadMore()" id="readMoreBtn">Read More...</a>
									</div>

									<style>
										#artistBio2 {display: none;}
									</style>
									<script>
										function ReadMore() {
                                            var dots = document.getElementById("dots");
											var moreText = document.getElementById("artistBio2");
