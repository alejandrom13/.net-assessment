         ...
         <header class="header mod-interior remodal-bg">
            <div class="header--holder">
               ...
               <div class="header--left">
                  <a class="header--left--logo" href=""><img src="//mtracks.azureedge.net/public/images/site/logo/en/logo-mono.svg" id="header_logoFull" class="header--left--logo--img mod-full" alt="MultiTracks.com"></a>
               ...
               <div class="header--right">
                   <div style="margin-top:10px;margin-right:50px; font-size: 15px">
                       <a href="ArtistDetails.aspx?Id=">Artist Details</a>
                   </div>
               </div>
            </div>
         </header>
                           ...
                           <h2>Welcome!</h2>
                            ...
                            <ul runat="server" id="items">
                                ...
                                <div class="form-row" style="margin-top: 2rem">
                                    <input name="Id" type="number" id="Id" class="form-row--input input" placeholder="Insert an artist id">

                                </div>

                            <div style="margin-right:20%;" align="">
                                <div>
                                     <input style="margin-left:1%" onclick="GoToAlbums()" class="login--login-btn btn" value="Find artist albums" />
                                </div>

                                <div>
                                     <input onclick="GoToSongs()" class="login--login-btn btn" value="Find artist songs" />
                                </div>

                                <div>
                                     <input style="margin-right:1%" onclick="GoToArtistDetails()" class="login--login-btn btn" value="Find artist" />
                                </div>
                            ...
                            <script>
                                function GoToArtistDetails() {
                                    ...
                                    window.location.href = 'ArtistDetails.aspx?Id=' + Id;
                                }
                                function GoToSongs() {
                                    var Id = document.getElementById("Id").value;
                                    window.location.href = 'ArtistSongs.aspx?Id=' + Id;
                                }
                                function GoToAlbums() {
                                    var Id = document.getElementById("Id").value;
                                    window.location.href = 'ArtistAlbums.aspx?Id=' + Id;
                                }
